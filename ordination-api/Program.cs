...
builder.Services.AddDbContext<OrdinationContext>(
...
app.MapGet(
    ...
    (DataService service) =>
    {
        ...
        return Results.Ok(new { pn, dagligFast, dagligSkaev });
    }
);
...
app.MapPost(
    "/api/ordinationer/pn/",
    (DataService service, PN_DTO dto) =>
    {
        return service.OpretPN(
            dto.patientId,
            dto.laegemiddelId,
            dto.antal,
            dto.startDato,
...
app.MapPost(
    "/api/ordinationer/dagligfast/",
    (DataService service, DagligFastDTO dto) =>
    {
        return service.OpretDagligFast(
            dto.patientId,
            dto.laegemiddelId,
            dto.antalMorgen,
            dto.antalMiddag,
...
app.MapPost(
    "/api/ordinationer/dagligskaev/",
    (DataService service, DagligSkaevDTO dto) =>
    {
        return service.OpretDagligSkaev(
            dto.patientId,
            dto.laegemiddelId,
            dto.doser,
            dto.startDato,
...
app.MapPut(
    "/api/ordinationer/pn/{id}/anvend",
    (DataService service, int id, DateTimeDTO dto) =>
    {
...
app.MapPost(
    "/api/patienter/{id}/beregnAnbefaletDosisPerDøgn",
    (DataService service, int id, AnbefaletDosisDTO dto) =>
    {
